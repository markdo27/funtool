...
interface BarProps {
  ...
  setMode: any;
  typeActive: boolean;
  setTypeActive: (v: boolean) => void;
  onTextColorChange: (c: string) => void;
}

export function Bars({ state, setMode, typeActive, setTypeActive, onTextColorChange }: BarProps) {
        ...
        <div className="flex">
          {isFocus ? null : (
            <>
              ...
              <Button
                textColor={textColor}
                clickHandler={() => setTypeActive(!typeActive)}
                active={typeActive}
              >
                <u>t</u>ype
              </Button>
              <HandleShortcut
                action={() => setTypeActive(!typeActive)}
                shortcut={"t"}
              />
            </>
          )}
